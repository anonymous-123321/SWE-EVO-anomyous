...
class SimpleBatchInstance(BaseModel):
    ...
    def from_swe_bench(cls, instance: dict[str, Any]) -> Self:
        ...
        if image_name is None:
            ...
            image_name = instance['image'] # (TODO) use 'image' in instance
        extra_fields = {}
...
class InstancesFromFile(BaseModel, AbstractInstanceSource):
    ...
    def get_instance_configs(self) -> list[BatchInstance]:
        ...
        for instance_dict in instance_dicts:
            instance_dict['image_name'] = instance_dict['image'] # (TODO) SWE-agent use 'image_name' as key instead of 'image' => Therefore we need this step
...
class SWEBenchInstances(BaseModel, AbstractInstanceSource):
    ...
    def get_instance_configs(self) -> list[BatchInstance]:
        ...
        ds: list[dict[str, Any]] = load_from_disk(self._get_dataset_path())[self.split]  # (TODO) 
